...
function cloneDeep(source) {
  ...
  const output = __spreadValues({}, source);
...
function mergeDeep(target, source) {
  if (isObject(source) && Object.keys(source).length === 0) {
    return cloneDeep(__spreadValues(__spreadValues({}, target), source));
  }
  let output = __spreadValues(__spreadValues({}, target), source);
...
var AccordionContent = (_a) => {
  var _b = _a, { children, className, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "className", "theme"]);
  const { isOpen } = useAccordionContext();
  const theme2 = mergeDeep(useTheme().theme.accordion.content, customTheme);
  return (0, import_jsx_runtime2.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames.default)(theme2.base, className), "data-testid": "flowbite-accordion-content", hidden: !isOpen }, props), { children }));
};
...
var AccordionTitle = (_a) => {
  var _b = _a, { as: Heading = "h2", children, className, theme: customTheme = {} } = _b, props = __objRest(_b, ["as", "children", "className", "theme"]);
  const { arrowIcon: ArrowIcon, flush, isOpen, setOpen } = useAccordionContext();
  const onClick = () => typeof setOpen !== "undefined" && setOpen();
  const theme2 = mergeDeep(useTheme().theme.accordion.title, customTheme);
  return (0, import_jsx_runtime4.jsxs)("button", __spreadProps(__spreadValues({ className: (0, import_classnames2.default)(theme2.base, theme2.flush[flush ? "on" : "off"], theme2.open[isOpen ? "on" : "off"], className), onClick, type: "button" }, props), { children: [(0, import_jsx_runtime4.jsx)(Heading, { className: theme2.heading, "data-testid": "flowbite-accordion-heading", children }), ArrowIcon && (0, import_jsx_runtime4.jsx)(ArrowIcon, { "aria-hidden": true, className: (0, import_classnames2.default)(theme2.arrow.base, theme2.arrow.open[isOpen ? "on" : "off"]), "data-testid": "flowbite-accordion-arrow" })] }));
};

// node_modules/flowbite-react/lib/esm/components/Accordion/Accordion.js
var AccordionComponent = (_a) => {
  var _b = _a, { alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, collapseAll = false, className, theme: customTheme = {} } = _b, props = __objRest(_b, ["alwaysOpen", "arrowIcon", "children", "flush", "collapseAll", "className", "theme"]);
  ...
  return (0, import_jsx_runtime5.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames3.default)(theme2.base, theme2.flush[flush ? "on" : "off"], className), "data-testid": "flowbite-accordion" }, props), { children: panels }));
};
...
var AvatarGroup = (_a) => {
  ...
  return (0, import_jsx_runtime8.jsx)("div", __spreadProps(__spreadValues({ "data-testid": "avatar-group-element", className: (0, import_classnames5.default)(theme2.base, className) }, props), { children }));
};
...
var AvatarComponent = (_a) => {
  var _b = _a, { alt = "", bordered = false, children, img, color = "light", rounded = false, size: size2 = "md", stacked = false, status, statusPosition = "top-left", placeholderInitials = "", className, theme: customTheme = {} } = _b, props = __objRest(_b, ["alt", "bordered", "children", "img", "color", "rounded", "size", "stacked", "status", "statusPosition", "placeholderInitials", "className", "theme"]);
...
var Badge = (_a) => {
  var _b = _a, { children, color = "info", href, icon: Icon, size: size2 = "xs", className, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "color", "href", "icon", "size", "className", "theme"]);
  const theme2 = mergeDeep(useTheme().theme.badge, customTheme);
  const Content = () => (0, import_jsx_runtime11.jsxs)("span", __spreadProps(__spreadValues({ className: (0, import_classnames8.default)(theme2.root.base, theme2.root.color[color], theme2.icon[Icon ? "on" : "off"], theme2.root.size[size2], className), "data-testid": "flowbite-badge" }, props), { children: [Icon && (0, import_jsx_runtime11.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size2], "data-testid": "flowbite-badge-icon" }), children && (0, import_jsx_runtime11.jsx)("span", { children })] }));
...
var BreadcrumbItem = (0, import_react8.forwardRef)((_a, ref) => {
  var _b = _a, { children, className, href, icon: Icon, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "className", "href", "icon", "theme"]);
  const isLink = typeof href !== "undefined";
  const Component = isLink ? "a" : "span";
  const theme2 = mergeDeep(useTheme().theme.breadcrumb.item, customTheme);
  return (0, import_jsx_runtime12.jsxs)("li", __spreadProps(__spreadValues({ className: (0, import_classnames9.default)(theme2.base, className) }, props), { children: [(0, import_jsx_runtime12.jsx)(HiOutlineChevronRight, { "aria-hidden": true, className: theme2.chevron, "data-testid": "flowbite-breadcrumb-separator" }), (0, import_jsx_runtime12.jsxs)(Component, { ref, className: theme2.href[isLink ? "on" : "off"], "data-testid": "flowbite-breadcrumb-item", href, children: [Icon && (0, import_jsx_runtime12.jsx)(Icon, { "aria-hidden": true, className: theme2.icon }), children] })] }));
});
BreadcrumbItem.displayName = "Breadcrumb.Item";
var BreadcrumbItem_default = BreadcrumbItem;

// node_modules/flowbite-react/lib/esm/components/Breadcrumb/Breadcrumb.js
var BreadcrumbComponent = (_a) => {
  var _b = _a, { children, className, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "className", "theme"]);
  const theme2 = mergeDeep(useTheme().theme.breadcrumb.root, customTheme);
  return (0, import_jsx_runtime13.jsx)("nav", __spreadProps(__spreadValues({ "aria-label": "Breadcrumb", className: (0, import_classnames10.default)(theme2.base, className) }, props), { children: (0, import_jsx_runtime13.jsx)("ol", { className: theme2.list, children }) }));
};
...
var ButtonGroup = (_a) => {
  var _b = _a, { children, outline, pill, className } = _b, props = __objRest(_b, ["children", "outline", "pill", "className"]);
  ...
  return (0, import_jsx_runtime14.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames11.default)(theme2.base, className), role: "group" }, props), { children: items }));
};
ButtonGroup.displayName = "Button.Group";
var ButtonGroup_default = ButtonGroup;

// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react10.forwardRef)((_a, ref) => {
  var _b = _a, { children, color = "info", disabled = false, gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, fullSized, positionInGroup = "none", size: size2 = "md", className } = _b, props = __objRest(_b, ["children", "color", "disabled", "gradientDuoTone", "gradientMonochrome", "href", "label", "outline", "pill", "fullSized", "positionInGroup", "size", "className"]);
  var _a2;
  const isLink = typeof href !== "undefined";
  const { buttonGroup: groupTheme, button: theme2 } = useTheme().theme;
  const Component = isLink ? "a" : "button";
  const theirProps = props;
  return (0, import_jsx_runtime15.jsx)(Component, __spreadProps(__spreadValues({ className: (0, import_classnames12.default)(disabled && theme2.disabled, !gradientDuoTone && !gradientMonochrome && theme2.color[color], gradientDuoTone && !gradientMonochrome && theme2.gradientDuoTone[gradientDuoTone], !gradientDuoTone && gradientMonochrome && theme2.gradient[gradientMonochrome], groupTheme.position[positionInGroup], outline && ((_a2 = theme2.outline.color[color]) != null ? _a2 : theme2.outline.color.default), theme2.base, theme2.pill[pill ? "on" : "off"], fullSized && theme2.fullSized, className), disabled, href, type: isLink ? void 0 : "button", ref }, theirProps), { children: (0, import_jsx_runtime15.jsx)("span", { className: (0, import_classnames12.default)(theme2.inner.base, theme2.inner.position[positionInGroup], theme2.outline[outline ? "on" : "off"], theme2.outline.pill[outline && pill ? "on" : "off"], theme2.size[size2], outline && !theme2.outline.color[color] && theme2.inner.outline), children: (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [typeof children !== "undefined" && children, typeof label !== "undefined" && (0, import_jsx_runtime15.jsx)("span", { className: theme2.label, "data-testid": "flowbite-button-label", children: label })] }) }) }));
});
...
var Card = (_a) => {
  var _b = _a, { children, className, horizontal, href, imgAlt, imgSrc, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "className", "horizontal", "href", "imgAlt", "imgSrc", "theme"]);
  const Component = typeof href === "undefined" ? "div" : "a";
  const theirProps = props;
  const theme2 = mergeDeep(useTheme().theme.card, customTheme);
  return (0, import_jsx_runtime16.jsxs)(Component, __spreadProps(__spreadValues({ className: (0, import_classnames13.default)(theme2.root.base, theme2.root.horizontal[horizontal ? "on" : "off"], href && theme2.root.href, className), "data-testid": "flowbite-card", href }, theirProps), { children: [imgSrc && (0, import_jsx_runtime16.jsx)("img", { alt: imgAlt != null ? imgAlt : "", className: (0, import_classnames13.default)(theme2.img.base, theme2.img.horizontal[horizontal ? "on" : "off"]), src: imgSrc }), (0, import_jsx_runtime16.jsx)("div", { className: theme2.root.children, children })] }));
};
...
!function(t2, e2) {
  ...
  if (t2 && typeof document != "undefined") {
    ...
    r2.type = "text/css", n2 === "top" && o2.firstChild ? o2.insertBefore(r2, o2.firstChild) : o2.appendChild(r2), r2.styleSheet ? r2.styleSheet.cssText = t2 : r2.appendChild(document.createTextNode(t2));
  }
...
var p = function(e2) {
  function o2(n2) {
    ...
    return o3.onEndScroll = function() {
      ...
      o3.isDraggable(t2.target) && o3.isScrollable() && (o3.internal = true, o3.props.buttons.indexOf(t2.button) !== -1 && (o3.processClick(t2, t2.clientX, t2.clientY), t2.preventDefault(), o3.props.stopPropagation && t2.stopPropagation()));
...
// node_modules/flowbite-react/lib/esm/components/Carousel/Carousel.js
var Carousel = (_a) => {
  var _b = _a, { children, indicators = true, leftControl, rightControl, slide = true, slideInterval, className } = _b, props = __objRest(_b, ["children", "indicators", "leftControl", "rightControl", "slide", "slideInterval", "className"]);
...
var Checkbox = (0, import_react13.forwardRef)((_a, ref) => {
  var _b = _a, { theme: customTheme = {}, className } = _b, props = __objRest(_b, ["theme", "className"]);
  const theme2 = mergeDeep(useTheme().theme.checkbox, customTheme);
  return (0, import_jsx_runtime18.jsx)("input", __spreadValues({ ref, className: (0, import_classnames15.default)(theme2.root.base, className), type: "checkbox" }, props));
});
...
function useFloating2(_temp) {
  ...
  const setReference = React4.useCallback((node) => {
    ...
    if (isElement2(refs.reference.current) || refs.reference.current === null || node !== null && !isElement2(node)) {
      reference(node);
    }
  }, [reference, refs]);
...
var useInteractions = function(propsList) {
  ...
  const getItemProps = React4.useCallback((userProps) => mergeProps(userProps, propsList, "item"), deps);
  return React4.useMemo(() => ({
    getReferenceProps,
    getFloatingProps,
    getItemProps
...
// node_modules/flowbite-react/lib/esm/components/Floating/Floating.js
var Floating = (_a) => {
  var _b = _a, { children, content, theme: theme2, animation = "duration-300", arrow: arrow3 = true, placement = "top", style = "dark", trigger = "hover", closeRequestKey, className } = _b, props = __objRest(_b, ["children", "content", "theme", "animation", "arrow", "placement", "style", "trigger", "closeRequestKey", "className"]);
  ...
  return (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [(0, import_jsx_runtime20.jsx)("div", __spreadProps(__spreadValues({ className: theme2.target }, getReferenceProps({ ref: reference })), { "data-testid": "flowbite-tooltip-target", children })), (0, import_jsx_runtime20.jsxs)("div", __spreadProps(__spreadValues({ "data-testid": "flowbite-tooltip" }, getFloatingProps(__spreadValues({
  ...
  }, props))), { children: [(0, import_jsx_runtime20.jsx)("div", { className: theme2.content, children: content }), arrow3 && (0, import_jsx_runtime20.jsx)("div", { className: (0, import_classnames17.default)(theme2.arrow.base, {
...
var DropdownHeader = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.dropdown.floating.header;
  return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [(0, import_jsx_runtime22.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames18.default)(theme2, className) }, props), { children })), (0, import_jsx_runtime22.jsx)(DropdownDivider, {})] });
};
...
var DropdownComponent = (_a) => {
  var _b = _a, { children, className, dismissOnClick = true } = _b, props = __objRest(_b, ["children", "className", "dismissOnClick"]);
  const theme2 = useTheme().theme.dropdown;
  const theirProps = props;
  const _a2 = theirProps, { placement = props.inline ? "bottom-start" : "bottom", trigger = "click", label, inline: inline2, floatingArrow = false, arrowIcon = true } = _a2, buttonProps = __objRest(_a2, ["placement", "trigger", "label", "inline", "floatingArrow", "arrowIcon"]);
  const Icon = (0, import_react20.useMemo)(() => {
    var _a3;
    const [p2] = placement.split("-");
    return (_a3 = icons[p2]) != null ? _a3 : HiOutlineChevronDown;
  }, [placement]);
  ...
  const attachCloseListener = (node) => {
    ...
    if (node.type === DropdownItem)
      return import_react20.default.cloneElement(node, {
        onClick: () => {
          var _a3, _b2;
          (_b2 = (_a3 = node.props).onClick) == null ? void 0 : _b2.call(_a3);
  ...
  const TriggerWrapper = ({ children: children2 }) => inline2 ? (0, import_jsx_runtime24.jsx)("button", { className: theme2.inlineWrapper, children: children2 }) : (0, import_jsx_runtime24.jsx)(Button, __spreadProps(__spreadValues({}, buttonProps), { children: children2 }));
...
var HelperText = (_a) => {
  var _b = _a, { value, children, color = "default", className } = _b, props = __objRest(_b, ["value", "children", "color", "className"]);
  var _a2;
  const theme2 = useTheme().theme.helperText;
  return (0, import_jsx_runtime25.jsx)("p", __spreadProps(__spreadValues({ className: (0, import_classnames20.default)(theme2.base, theme2.colors[color], className) }, props), { children: (_a2 = value != null ? value : children) != null ? _a2 : "" }));
};

// node_modules/flowbite-react/lib/esm/components/FileInput/FileInput.js
var FileInput = (0, import_react21.forwardRef)((_a, ref) => {
  var _b = _a, { theme: customTheme = {}, sizing = "md", helperText, color = "gray", className } = _b, props = __objRest(_b, ["theme", "sizing", "helperText", "color", "className"]);
  const theme2 = mergeDeep(useTheme().theme.fileInput, customTheme);
  return (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [(0, import_jsx_runtime26.jsx)("div", { className: (0, import_classnames21.default)(theme2.base, className), children: (0, import_jsx_runtime26.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime26.jsx)("input", __spreadProps(__spreadValues({ className: (0, import_classnames21.default)(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing]) }, props), { type: "file", ref })) }) }), helperText && (0, import_jsx_runtime26.jsx)(HelperText, { color, children: helperText })] });
});
...
var FooterCopyright = ({ href, by, year, className }) => {
  ...
  return (0, import_jsx_runtime28.jsx)("div", { children: (0, import_jsx_runtime28.jsxs)("span", { className: (0, import_classnames23.default)(theme2.base, className), "data-testid": "flowbite-footer-copyright", children: ["\xA9 ", year, href ? (0, import_jsx_runtime28.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime28.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] }) });
};
...
var Label = (_a) => {
  var _b = _a, { children, color = "default", disabled = false, value, className } = _b, props = __objRest(_b, ["children", "color", "disabled", "value", "className"]);
  var _a2;
  const theme2 = useTheme().theme.label;
  return (0, import_jsx_runtime35.jsx)("label", __spreadProps(__spreadValues({ className: (0, import_classnames30.default)(theme2.base, theme2.colors[color], disabled != null ? disabled : theme2.disabled, className) }, props), { children: (_a2 = value != null ? value : children) != null ? _a2 : "" }));
};
...
var ListGroupItem = (_a) => {
  var _b = _a, { active: isActive, children, href, icon: Icon, onClick, className } = _b, props = __objRest(_b, ["active", "children", "href", "icon", "onClick", "className"]);
  const isLink = typeof href !== "undefined";
  const Component = isLink ? "a" : "button";
  const theme2 = useTheme().theme.listGroup.item;
  const theirProps = props;
  return (0, import_jsx_runtime36.jsx)("li", { children: (0, import_jsx_runtime36.jsxs)(Component, __spreadProps(__spreadValues({ className: (0, import_classnames31.default)(theme2.active[isActive ? "on" : "off"], theme2.base, theme2.href[isLink ? "on" : "off"]), href, onClick, type: isLink ? void 0 : "button" }, theirProps), { children: [Icon && (0, import_jsx_runtime36.jsx)(Icon, { "aria-hidden": true, className: theme2.icon, "data-testid": "flowbite-list-group-item-icon" }), children] })) });
};

// node_modules/flowbite-react/lib/esm/components/ListGroup/ListGroup.js
var ListGroupComponent = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.listGroup.base;
  const theirProps = props;
  return (0, import_jsx_runtime37.jsx)("ul", __spreadProps(__spreadValues({ className: (0, import_classnames32.default)(theme2, className) }, theirProps), { children }));
};
...
var ModalBody = (_a) => {
  ...
  return (0, import_jsx_runtime38.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames33.default)(theme2.base, {
    [theme2.popup]: popup
...
var ModalFooter = (_a) => {
  ...
  return (0, import_jsx_runtime39.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames34.default)(theme2.base, {
    [theme2.popup]: !popup
  }, className) }, props), { children }));
};
...
var ModalHeader = (_a) => {
  ...
  return (0, import_jsx_runtime40.jsxs)("div", __spreadProps(__spreadValues({ className: (0, import_classnames35.default)(theme2.base, {
    [theme2.popup]: popup
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (_a) => {
  var _b = _a, { children, show, root = document.body, popup, size: size2 = "2xl", position = "center", dismissible = false, onClose, className } = _b, props = __objRest(_b, ["children", "show", "root", "popup", "size", "position", "dismissible", "onClose", "className"]);
...
var NavbarBrand = (_a) => {
  var _b = _a, { theme: customTheme = {}, children, className, as: Component = "a" } = _b, props = __objRest(_b, ["theme", "children", "className", "as"]);
  const theme2 = mergeDeep(useTheme().theme.navbar.brand, customTheme);
  return (0, import_jsx_runtime42.jsx)(Component, __spreadProps(__spreadValues({ className: (0, import_classnames37.default)(theme2.base, className) }, props), { children }));
};
...
// node_modules/flowbite-react/lib/esm/components/Navbar/NavbarCollapse.js
var NavbarCollapse = (_a) => {
  var _b = _a, { theme: customTheme = {}, children, className } = _b, props = __objRest(_b, ["theme", "children", "className"]);
  const { isOpen } = useNavbarContext();
  const theme2 = mergeDeep(useTheme().theme.navbar.collapse, customTheme);
  return (0, import_jsx_runtime43.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames38.default)(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), "data-testid": "flowbite-navbar-collapse" }, props), { children: (0, import_jsx_runtime43.jsx)("ul", { className: theme2.list, children }) }));
};
...
var NavbarLink = (_a) => {
  var _b = _a, { active, disabled, theme: customTheme = {}, children, className, as: Component = "a" } = _b, props = __objRest(_b, ["active", "disabled", "theme", "children", "className", "as"]);
  const theme2 = mergeDeep(useTheme().theme.navbar.link, customTheme);
  return (0, import_jsx_runtime44.jsx)("li", { children: (0, import_jsx_runtime44.jsx)(Component, __spreadProps(__spreadValues({ className: (0, import_classnames39.default)(theme2.base, {
...
// node_modules/flowbite-react/lib/esm/components/Navbar/NavbarToggle.js
var NavbarToggle = (_a) => {
  var _b = _a, { barIcon: BarIcon = GoThreeBars, theme: customTheme = {}, className } = _b, props = __objRest(_b, ["barIcon", "theme", "className"]);
  const { isOpen, setIsOpen } = useNavbarContext();
  const handleClick = () => {
    setIsOpen(!isOpen);
  };
  const theme2 = mergeDeep(useTheme().theme.navbar.toggle, customTheme);
  return (0, import_jsx_runtime45.jsxs)("button", __spreadProps(__spreadValues({ className: (0, import_classnames40.default)(theme2.base, className), "data-testid": "flowbite-navbar-toggle", onClick: handleClick }, props), { children: [(0, import_jsx_runtime45.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime45.jsx)(BarIcon, { className: theme2.icon })] }));
};

// node_modules/flowbite-react/lib/esm/components/Navbar/Navbar.js
var NavbarComponent = (_a) => {
  var _b = _a, { children, menuOpen, fluid = false, rounded, border, className, theme: customTheme = {} } = _b, props = __objRest(_b, ["children", "menuOpen", "fluid", "rounded", "border", "className", "theme"]);
  const [isOpen, setIsOpen] = (0, import_react26.useState)(menuOpen);
  const theme2 = mergeDeep(useTheme().theme.navbar.root, customTheme);
  return (0, import_jsx_runtime46.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime46.jsx)("nav", __spreadProps(__spreadValues({ className: (0, import_classnames41.default)(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className) }, props), { children: (0, import_jsx_runtime46.jsx)("div", { className: (0, import_classnames41.default)(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) })) });
};
...
// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var Pagination = (_a) => {
  var _b = _a, { currentPage, layout = "pagination", onPageChange, showIcons: showIcon = false, totalPages, previousLabel = "Previous", nextLabel = "Next", className, renderPaginationButton = (props2) => (0, import_jsx_runtime48.jsx)(PaginationButton_default, __spreadValues({}, props2)) } = _b, props = __objRest(_b, ["currentPage", "layout", "onPageChange", "showIcons", "totalPages", "previousLabel", "nextLabel", "className", "renderPaginationButton"]);
...
var Progress = (_a) => {
  var _b = _a, { color = "blue", label = "progressbar", labelPosition = "none", labelProgress = false, progress, size: size2 = "md", className } = _b, props = __objRest(_b, ["color", "label", "labelPosition", "labelProgress", "progress", "size", "className"]);
  const id = (0, import_react27.useId)();
  const theme2 = useTheme().theme.progress;
  return (0, import_jsx_runtime49.jsx)(import_jsx_runtime49.Fragment, { children: (0, import_jsx_runtime49.jsxs)("div", __spreadProps(__spreadValues({ id, "aria-label": label, "aria-valuenow": progress, role: "progressbar" }, props), { children: [label && labelPosition === "outside" && (0, import_jsx_runtime49.jsxs)("div", { className: theme2.label, children: [(0, import_jsx_runtime49.jsx)("span", { children: label }), labelProgress && (0, import_jsx_runtime49.jsxs)("span", { children: [progress, "%"] })] }), (0, import_jsx_runtime49.jsx)("div", { className: (0, import_classnames44.default)(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime49.jsx)("div", { className: (0, import_classnames44.default)(theme2.bar, theme2.color[color], theme2.size[size2]), style: { width: `${progress}%` }, children: label && labelPosition === "inside" && label }) })] })) });
};
...
var Radio = (0, import_react28.forwardRef)((_a, ref) => {
  ...
  return (0, import_jsx_runtime50.jsx)("input", __spreadValues({ ref, className: (0, import_classnames45.default)(theme2.root.base, className), type: "radio" }, props));
});
...
var RatingAdvanced = (_a) => {
  var _b = _a, { percentFilled = 0, children, className } = _b, props = __objRest(_b, ["percentFilled", "children", "className"]);
  const theme2 = useTheme().theme.rating.advanced;
  return (0, import_jsx_runtime52.jsxs)("div", __spreadProps(__spreadValues({ className: (0, import_classnames47.default)(theme2.base, className) }, props), { children: [(0, import_jsx_runtime52.jsx)("span", { className: theme2.label, children }), (0, import_jsx_runtime52.jsx)("div", { className: theme2.progress.base, children: (0, import_jsx_runtime52.jsx)("div", { className: theme2.progress.fill, "data-testid": "flowbite-rating-fill", style: { width: `${percentFilled}%` } }) }), (0, import_jsx_runtime52.jsx)("span", { className: theme2.progress.label, children: `${percentFilled}%` })] }));
};
...
// node_modules/flowbite-react/lib/esm/components/Rating/Rating.js
var RatingComponent = (_a) => {
  var _b = _a, { children, size: size2 = "sm", className } = _b, props = __objRest(_b, ["children", "size", "className"]);
  const theme2 = useTheme().theme.rating;
  return (0, import_jsx_runtime54.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime54.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames49.default)(theme2.base, className) }, props), { children })) });
};
...
var Tooltip = (_a) => {
  var _b = _a, { animation = "duration-300", arrow: arrow3 = true, children, content, placement = "top", style = "dark", trigger = "hover", className } = _b, props = __objRest(_b, ["animation", "arrow", "children", "content", "placement", "style", "trigger", "className"]);
  const theme2 = useTheme().theme.tooltip;
  return (0, import_jsx_runtime56.jsx)(Floating, __spreadProps(__spreadValues({ content, style, animation, placement, arrow: arrow3, trigger, theme: theme2, className }, props), { children }));
};
...
// node_modules/flowbite-react/lib/esm/components/Sidebar/SidebarCollapse.js
var SidebarCollapse = (_a) => {
  var _b = _a, { children, icon: Icon, label, className, open = false } = _b, props = __objRest(_b, ["children", "icon", "label", "className", "open"]);
...
var SidebarCTA = (_a) => {
  var _b = _a, { children, color = "info", className } = _b, props = __objRest(_b, ["children", "color", "className"]);
  const { isCollapsed } = useSidebarContext();
  const theme2 = useTheme().theme.sidebar.cta;
  return (0, import_jsx_runtime58.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames52.default)(theme2.base, theme2.color[color], className), "data-testid": "sidebar-cta", hidden: isCollapsed }, props), { children }));
};
...
var SidebarItem = (0, import_react35.forwardRef)((_a, ref) => {
  var _b = _a, { as: Component = "a", children, icon: Icon, active: isActive, label, labelColor = "info", className } = _b, props = __objRest(_b, ["as", "children", "icon", "active", "label", "labelColor", "className"]);
  var _a2;
  const id = (0, import_react35.useId)();
  const { isCollapsed } = useSidebarContext();
  const { isInsideCollapse } = useSidebarItemContext();
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime59.jsx)(ListItem, { id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime59.jsxs)(Component, __spreadProps(__spreadValues({ "aria-labelledby": `flowbite-sidebar-item-${id}`, className: (0, import_classnames53.default)(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && theme2.collapsed.insideCollapse, className), ref }, props), { children: [Icon && (0, import_jsx_runtime59.jsx)(Icon, { "aria-hidden": true, className: (0, import_classnames53.default)(theme2.icon.base, isActive && theme2.icon.active), "data-testid": "flowbite-sidebar-item-icon" }), isCollapsed && !Icon && (0, import_jsx_runtime59.jsx)("span", { className: theme2.collapsed.noIcon, children: (_a2 = children.charAt(0).toLocaleUpperCase()) != null ? _a2 : "?" }), !isCollapsed && (0, import_jsx_runtime59.jsx)(Children5, { id, children }), !isCollapsed && label && (0, import_jsx_runtime59.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] })) });
});
...
var SidebarItemGroup = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.sidebar.itemGroup;
  return (0, import_jsx_runtime60.jsx)("ul", __spreadProps(__spreadValues({ className: (0, import_classnames54.default)(theme2, className), "data-testid": "flowbite-sidebar-item-group" }, props), { children: (0, import_jsx_runtime60.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) }));
};
...
var SidebarItems = (_a) => {
  ...
  return (0, import_jsx_runtime61.jsx)("div", __spreadProps(__spreadValues({ className: (0, import_classnames55.default)(theme2, className), "data-testid": "flowbite-sidebar-items" }, props), { children }));
};
...
var SidebarLogo = (_a) => {
  var _b = _a, { children, href, img, imgAlt = "", className } = _b, props = __objRest(_b, ["children", "href", "img", "imgAlt", "className"]);
  const id = (0, import_react36.useId)();
  const { isCollapsed } = useSidebarContext();
  const theme2 = useTheme().theme.sidebar.logo;
  return (0, import_jsx_runtime62.jsxs)("a", __spreadProps(__spreadValues({ "aria-labelledby": `flowbite-sidebar-logo-${id}`, className: (0, import_classnames56.default)(theme2.base, className), href }, props), { children: [(0, import_jsx_runtime62.jsx)("img", { alt: imgAlt, className: theme2.img, src: img }), (0, import_jsx_runtime62.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] }));
};
SidebarLogo.displayName = "Sidebar.Logo";
var SidebarLogo_default = SidebarLogo;

// node_modules/flowbite-react/lib/esm/components/Sidebar/Sidebar.js
var SidebarComponent = (_a) => {
  var _b = _a, { children, collapseBehavior = "collapse", collapsed: isCollapsed = false } = _b, props = __objRest(_b, ["children", "collapseBehavior", "collapsed"]);
  const theme2 = useTheme().theme.sidebar;
  return (0, import_jsx_runtime63.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime63.jsx)("aside", __spreadProps(__spreadValues({ "aria-label": "Sidebar", className: (0, import_classnames57.default)(theme2.base, theme2.collapsed[isCollapsed ? "on" : "off"]), hidden: isCollapsed && collapseBehavior === "hide" }, props), { children: (0, import_jsx_runtime63.jsx)("div", { className: theme2.inner, children }) })) });
};
...
// node_modules/flowbite-react/lib/esm/components/Tab/Tabs.js
var TabsComponent = (0, import_react37.forwardRef)((_a, ref) => {
  var _b = _a, { children, style = "default", className, onActiveTabChange } = _b, rest = __objRest(_b, ["children", "style", "className", "onActiveTabChange"]);
...
var TableBody = (_a) => {
  var _b = _a, { children } = _b, props = __objRest(_b, ["children"]);
  return (0, import_jsx_runtime67.jsx)("tbody", __spreadProps(__spreadValues({}, props), { children }));
};
...
var TableCell = (_a) => {
  ...
  return (0, import_jsx_runtime68.jsx)("td", __spreadProps(__spreadValues({ className: (0, import_classnames60.default)(theme2.base, className) }, props), { children }));
};
...
var TableHead = (_a) => {
  ...
  return (0, import_jsx_runtime69.jsx)("thead", __spreadProps(__spreadValues({ className: (0, import_classnames61.default)(theme2.head.base, className) }, props), { children: (0, import_jsx_runtime69.jsx)("tr", { children }) }));
};
...
var TableHeadCell = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.table.head.cell;
  return (0, import_jsx_runtime70.jsx)("th", __spreadProps(__spreadValues({ className: (0, import_classnames62.default)(theme2.base, className) }, props), { children }));
};
...
var TableRow = (_a) => {
  ...
  return (0, import_jsx_runtime71.jsx)("tr", __spreadProps(__spreadValues({ "data-testid": "table-row-element", className: (0, import_classnames63.default)(striped && theme2.striped, hoverable && theme2.hovered, className) }, props), { children }));
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = (_a) => {
  var _b = _a, { children, striped, hoverable, className } = _b, props = __objRest(_b, ["children", "striped", "hoverable", "className"]);
  const theme2 = useTheme().theme.table;
  return (0, import_jsx_runtime72.jsx)("div", { "data-testid": "table-element", className: (0, import_classnames64.default)(theme2.wrapper), children: (0, import_jsx_runtime72.jsx)(TableContext.Provider, { value: { striped, hoverable }, children: (0, import_jsx_runtime72.jsx)("table", __spreadProps(__spreadValues({ className: (0, import_classnames64.default)(theme2.base, className) }, props), { children })) }) });
};
...
var Textarea = (0, import_react39.forwardRef)((_a, ref) => {
  var _b = _a, { shadow, helperText, color = "gray", className } = _b, props = __objRest(_b, ["shadow", "helperText", "color", "className"]);
  const theme2 = useTheme().theme.textarea;
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime73.Fragment, { children: [(0, import_jsx_runtime73.jsx)("textarea", __spreadValues({ ref, className: (0, import_classnames65.default)(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className) }, props)), helperText && (0, import_jsx_runtime73.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = (_a) => {
  ...
  return (0, import_jsx_runtime75.jsx)("p", __spreadProps(__spreadValues({ className: (0, import_classnames67.default)(theme2.body, className) }, props), { children }));
};
...
// node_modules/flowbite-react/lib/esm/components/Timeline/TimelineContent.js
var TimelineContent = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.timeline.item.content;
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime76.jsx)("div", __spreadProps(__spreadValues({ "data-testid": "timeline-content", className: (0, import_classnames68.default)(horizontal && theme2.base, className) }, props), { children }));
};
...
var TimelineItem = (_a) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime77.jsx)("li", __spreadProps(__spreadValues({ "data-testid": "timeline-item", className: (0, import_classnames69.default)(horizontal && theme2.base.horizontal, !horizontal && theme2.base.vertical, className) }, props), { children }));
};
...
var TimelinePoint = (_a) => {
  var _b = _a, { children, className, icon: Icon } = _b, props = __objRest(_b, ["children", "className", "icon"]);
  const theme2 = useTheme().theme.timeline.item.point;
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime78.jsxs)("div", __spreadProps(__spreadValues({ "data-testid": "timeline-point", className: (0, import_classnames70.default)(horizontal && theme2.base.horizontal, !horizontal && theme2.base.vertical, className) }, props), { children: [children, Icon ? (0, import_jsx_runtime78.jsx)("span", { className: (0, import_classnames70.default)(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime78.jsx)(Icon, { "aria-hidden": true, className: (0, import_classnames70.default)(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime78.jsx)("div", { className: (0, import_classnames70.default)(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime78.jsx)("div", { className: (0, import_classnames70.default)(theme2.line) })] }));
};
...
var TimelineTime = (_a) => {
  var _b = _a, { children, className } = _b, props = __objRest(_b, ["children", "className"]);
  const theme2 = useTheme().theme.timeline.item.content;
  return (0, import_jsx_runtime79.jsx)("time", __spreadProps(__spreadValues({ className: (0, import_classnames71.default)(theme2.time, className) }, props), { children }));
};
...
var TimelineTitle = (_a) => {
  var _b = _a, { children, className, as = "h3" } = _b, props = __objRest(_b, ["children", "className", "as"]);
  const theme2 = useTheme().theme.timeline.item.content;
  const Tag = as;
  return (0, import_jsx_runtime80.jsx)(Tag, __spreadProps(__spreadValues({ className: (0, import_classnames72.default)(theme2.title, className) }, props), { children }));
};
...
var ToastComponent = (_a) => {
  var _b = _a, { children, duration = 300, className } = _b, props = __objRest(_b, ["children", "duration", "className"]);
  ...
  return (0, import_jsx_runtime83.jsx)(ToastContext.Provider, { value: { duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime83.jsx)("div", __spreadProps(__spreadValues({ "data-testid": "flowbite-toast", className: (0, import_classnames75.default)(theme2.base, durationClasses[duration], { [theme2.closed]: isClosed }, { [theme2.removed]: isRemoved }, className) }, props), { children })) });
};
...
var ToggleSwitch = (_a) => {
  var _b = _a, { checked, disabled, label, name, onChange, className, color = "blue", theme: customTheme = {} } = _b, props = __objRest(_b, ["checked", "disabled", "label", "name", "onChange", "className", "color", "theme"]);
