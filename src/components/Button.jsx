...
const Button = ({ text, type, color = "purple", loading, onClick }) => {
  ...
  if (color === "yellow") {
    classColor =
      "bg-yellow-300 hover:bg-yellow-400 focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-900";
  }
  if (color === "green") {
    classColor =
      "bg-green-400 hover:bg-green-500 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900";
  }
